    ...
    <div class="flex w-full flex-col items-center">
      ...
      <div class="flex flex-row flex-wrap justify-center gap-8">
        ...
        <div class="bg-white dark:bg-black p-6 h-[42rem] w-[32rem] rounded-lg flex flex-col items-center justify-around">
          ...
          <div class="flex flex-row gap-14 my-4">
            ...
            <hr class="my-8 w-full h-1 bg-white dark:bg-black">

      <h1 class="text-5xl font-semibold underline underline-offset-8 mb-12 dark:text-white text-black decoration-neutral-500">Tech Stack</h1>
      <div class="rounded-lg flex flex-col flex-wrap gap-14 mx-36 items-center justify-center">
        <div class="flex flex-col items-center">
          ...
          <h1 class="text-2xl dark:text-white text-black my-4"><a href="https://streamlit.io/" target="_blank">Streamlit</a></h1>
        </div>
        <div class="flex flex-col items-center">
          <img class="bg-[#130654] h-12 w-18" src="https://pandas.pydata.org/static/img/pandas_white.svg" alt="">
          <h1 class="text-2xl dark:text-white text-black my-4"><a href="https://pandas.pydata.org/" target="_blank">Pandas</a></h1>
        </div>
        <div class="flex flex-col items-center">
          <div class="dark:bg-white rounded-lg p-2">
            <img class="h-12 w-18"
          ...
          <h1 class="text-2xl dark:text-white text-black my-4"><a href="https://www.tensorflow.org/" target="_blank">Tensorflow</a></h1>
        </div>
        <div class="flex flex-col items-center">
          <div class="dark:bg-white rounded-lg p-2">
            <img class="h-12 w-18" src="https://matplotlib.org/_static/logo_dark.svg" alt="">
          </div>
          <h1 class="text-2xl dark:text-white text-black my-4"><a href="https://matplotlib.org/" target="_blank">Matplotlib</a></h1>
        </div>
        <div class="flex flex-col items-center">
          <div class="dark:bg-white rounded-lg p-2">
            <img class="h-12 w-12" src="https://numpy.org/images/logo.svg" alt="">
          </div>
          <h1 class="text-2xl dark:text-white text-black my-4"><a href="https://numpy.org/" target="_blank">Numpy</a></h1>
        </div>
        <div class="flex flex-col items-center">
          <div class="dark:bg-white rounded-lg p-2">
            <img class="h-20 w-20" src="https://static.javatpoint.com/images/javascript/javascript_logo.png" alt="">
          </div>
          <h1 class="text-2xl dark:text-white text-black my-4">JavaScript</h1>
        </div>
        <div class="flex flex-col items-center">
          <div class="dark:bg-white rounded-lg p-2">
          ...
          <h1 class="text-2xl dark:text-white text-black my-4"><a href="https://tailwindcss.com/" target="_blank">Tailwind CSS</a></h1>
        </div>
        <div class="flex flex-col items-center">
          <div class="dark:bg-white rounded-lg py-3 px-6"> 
            <img class="h-16 w-16 rounded-lg" src="https://avatars.githubusercontent.com/u/32489070?v=4" alt="">
          </div>
          <h1 class="text-2xl dark:text-white text-black my-4"><a href="https://streamlit.io/" target="_blank">SheetDB</a></h1>
        </div>
      </div>
    </div>
