...
try:
  ...
  st.info("We read into your locality's litter data to let you know what type of waste is mostly littered in your locality")
  pass
...
# data = pd.DataFrame(
#     np.random.randn(20),
#     columns=["LitterType" , "LitterCount" , "UserName" , "Locality" , "Location"]
# )
